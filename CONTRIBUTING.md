...
Thanks for your interest in improving Durak! 

This project welcomes contributions that strengthen Turkish NLP tooling. 
Please review the guidelines below before opening an issue or submitting a pull request.

## Code of Conduct

Durak follows the standards in [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md). 
